...
* [`src/wordle/`](src/wordle/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/wordle/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `wordle` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/wordle/config.cljs) defaults to `true` in
...
```clj
(ns wordle.example
  (:require [wordle.config :as config])
